...
<head>
    ...
    <title>Rolls-Royce 2025 Ghost Series II</title>
...
<body>
    <header>
        <h1>Rolls-Royce 2025 Ghost Series II</h1>
    </header>
    ...
    <section id="overview">
        <h2>Overview</h2>
        <p>The 2025 Rolls-Royce Ghost Series II combines unparalleled luxury, advanced technology, and exceptional performance. Discover the craftsmanship and attention to detail that make this car an icon of elegance.</p>
    </section>
